...
function Login(){
  ...
  function LoginUsuario(){
    ...
    {sucesso === 'S' && email === "pierryboettscher12@gmail.com" ? navigate("/app/usuarioMaster") : sucesso === 'S' && email.match("@catolicasc.edu.br") ? navigate("/app/aluno") : sucesso === 'S' ? navigate("/app/home") : null}
